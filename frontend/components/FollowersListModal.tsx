      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[80vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        <div className="p-5">
          ...
          <div className="flex justify-between items-center mb-5">
            <h2 className="text-lg font-semibold text-neutral-900">Подписчики</h2>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center py-12 text-center">
              ...
              <p className="text-neutral-500 text-sm">Пока нет подписчиков</p>
            </div>
          ) : (
              ...
              {followers.map((follower) => (
                ...
                >
                  ...
                  <div className="flex-1 text-left min-w-0">
                    ...
                    <p className="text-sm text-gray-500 truncate">@{follower.friend.username}</p>
