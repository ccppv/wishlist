      ...
      <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-xl w-full max-w-md max-h-[80vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        <div className="p-5">
          ...
          <div className="flex justify-between items-center mb-5">
            <h2 className="text-lg font-semibold text-neutral-900 dark:text-white">Друзья</h2>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center py-12 text-center">
              ...
              <p className="text-neutral-500 dark:text-neutral-400 text-sm">Пока нет друзей</p>
              <p className="text-neutral-400 dark:text-neutral-500 text-xs mt-1">Найдите друзей через поиск</p>
            </div>
          ) : (
              ...
              {friends.map((friendship) => (
                ...
                >
                  ...
                  <div className="flex-1 text-left min-w-0">
                    ...
                    <p className="text-sm text-gray-500 dark:text-neutral-400 truncate">@{friendship.friend.username}</p>
